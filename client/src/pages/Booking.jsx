...
const Booking = () => {
  ...
  useEffect(() => {
    if (movie && showtime) {
      axios
        .get(
          `https://showtime-project-server.onrender.com/api/bookings/booked-seats?movie=${movie.title}&showtime=${showtime}`
        )
  ...
  const confirmFinalBooking = async () => {
    ...
    try {
      ...
      await axios.post(
        "https://showtime-project-server.onrender.com/api/bookings",
        newBooking,
        {
